...
public class ParameterCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context, boolean polar, boolean tick, boolean rgba, ParticleOptions effect, Vec3 pos, double size, Vector4f color, double light, Vec3 speed, double begin, double end, String expression, double step, int cpt, int age, String speedExpression, double speedStep, String group) {
